...
In order to run the basic front end application that was created for this project, first, you need to clone the project repository with the following link: 
...
<h4 align="start">Installing docker image</h4>
